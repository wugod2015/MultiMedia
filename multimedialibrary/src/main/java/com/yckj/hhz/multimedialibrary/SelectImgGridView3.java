...
public class SelectImgGridView3 extends ViewGroup {
    Context context;
    ...
    public SelectImgGridView3(Context context) {
        super(context);
        init(context, null, 0);
    }

    public SelectImgGridView3(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public SelectImgGridView3(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
